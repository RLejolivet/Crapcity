...
public class PlayerAvatar : MonoBehaviour
{
    ...
    [RPC]
    public void sendDestroyBuilding(int ncase)
    {
    ...
    [RPC]
    public void sendCreateBuilding(int ncase, string buildingname)
    {
    ...
    [RPC]
    public void sendWaste(float qty)
    {
